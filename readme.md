...
Inshorts is an app which provide news from different sources and present them under 60 words. This API Scraps content from the Inshorts website and provides it in easy way to use JSON Format. 
